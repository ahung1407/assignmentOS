...
/* Extract FPN */
// In RAM
#define PAGING_FPN_RAM(x) GETVAL(x, PAGING_PTE_FPN_MASK, PAGING_PTE_FPN_LOBIT)
// In SWAP
#define PAGING_FPN_SWAP(x) GETVAL(x, PAGING_PTE_SWPOFF_MASK, PAGING_PTE_SWPOFF_LOBIT)
